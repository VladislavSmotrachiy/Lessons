...
public class FunctionsExample
{
    public static void Main(string[] args)
    {
        ...
        // if (oneNumber > 100 && oneNumber < 1000)
        // {
        //     System.Console.WriteLine("твои число " + oneNumber + " YES");
        // }
        // else
        // {
        ...
        // int first = oneNumber / 100;
        // int second = oneNumber / 10 % 10;
        // int thri = oneNumber / 1 % 10;

        // System.Console.WriteLine(first);
        // System.Console.WriteLine(second);
        // System.Console.WriteLine(thri);

        // if (first != second && second != thri && first != thri)
        // {
